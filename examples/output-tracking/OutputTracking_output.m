...
%--------------------------------------------------------------------------
function [O,sol] = OutputTracking_output(T,U,Y,P,F,p,opts)
...
hashopts.Input = 'file';
filehash = DataHash('OutputTracking.m',hashopts);

% hashed file name
filename = [opts.mname,'_solution_',filehash,'.mat'];
fullname = fullfile(opts.mpath,'solution',filename);
