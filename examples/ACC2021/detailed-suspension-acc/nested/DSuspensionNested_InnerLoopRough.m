%--------------------------------------------------------------------------
% DSuspensionNested_InnerLoopRough.m
% Inner-loop problem for the rough road load case
%--------------------------------------------------------------------------
%
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
function [F,varargout] = DSuspensionNested_InnerLoopRough(x,auxdata)

% common inner-loop problem setup
[setup,Bz] = DSuspensionNested_InnerLoopCommonSetup(x,auxdata);

% dynamic constraints
setup = DSuspensionNested_RoughStateConstraints(x,auxdata,setup);
