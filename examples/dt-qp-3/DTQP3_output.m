...
%--------------------------------------------------------------------------
function [O,sol] = DTQP3_output(T,U,Y,P,F,p,opts)

% solution on T
sol(1).T = T;
sol(1).U = ones(size(T))*DTQP3_U(p.a1,p.a2,p.b,p.m,p.r,p.tf,p.w1,p.w2,p.x0);
sol(1).Y = DTQP3_Y(p.a1,p.a2,p.b,p.m,p.r,T,p.tf,p.w1,p.w2,p.x0);
