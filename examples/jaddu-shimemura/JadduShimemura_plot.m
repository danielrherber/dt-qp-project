%--------------------------------------------------------------------------
% JadduShimemura_plot.m
% Plot function for JadduShimemura example
%--------------------------------------------------------------------------
%
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
function JadduShimemura_plot(T,U,Y,P,F,in,opts,sol)
...
%         plot([0.332075214020703,0.332075214020703],[-2,2],'b')
    case 2
        t2 = linspace(0.2,0.8,1000);
        plot(t2,8*(t2-0.5).^2 - 0.5,'linewidth',1,'color','k'); hold on
end
