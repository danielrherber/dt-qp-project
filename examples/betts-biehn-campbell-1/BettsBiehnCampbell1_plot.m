%--------------------------------------------------------------------------
% BettsBiehnCampbell1_plot.m
% Plot function for BettsBiehnCampbell1 example
%--------------------------------------------------------------------------
%
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
function BettsBiehnCampbell1_plot(T,U,Y,P,F,in,opts,sol)
...
hL = legend(Lv);
set(hL,'interpreter','latex','location','best','fontsize',fontsize-4,'box','off')
...
% legend
hL = legend(Hv,Lv);
set(hL,'location','best','fontsize',fontsize-4,'box','off')
