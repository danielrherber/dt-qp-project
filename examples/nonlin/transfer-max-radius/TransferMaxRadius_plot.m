%--------------------------------------------------------------------------
% TransferMaxRadius_plot.m
% Plot function for TransferMaxRadius example
%--------------------------------------------------------------------------
%
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
function TransferMaxRadius_plot(T,U,Y,P,F,in,opts,sol)
...
ha.ThetaAxis.FontSize = fontsize-6; % change x tick font size
ha.RAxis.FontSize = fontsize-6; % change y tick font size
ha.ThetaAxis.Label.FontSize = fontsize; % change x label font size
ha.RAxis.Label.FontSize = fontsize; % change y label font size
ha.Box = 'on'; % box on
