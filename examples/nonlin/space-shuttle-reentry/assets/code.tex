...
\text{subject to:} \quad & \dot{\bm{\xi}} = \begin{bmatrix} \dot{r} \\ \dot{\theta} \\ \dot{\phi} \\ \dot{v} \\ \dot{\gamma} \\ \dot{\psi} \end{bmatrix} = \begin{bmatrix}
v \sin(\gamma) \\
...
\end{bmatrix} \\
& \bm{\xi}(0) = (r_0, \theta_0, \phi_0, v_0, \gamma_0, \psi_0) \\
& (r,v,\gamma)(t_f) = (r_f,v_f,\gamma_f) \\
& \bm{\xi}_{\min} \leq \bm{\xi}(t) \leq \bm{\xi}_{\max} \\
